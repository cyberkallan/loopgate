                                        ...
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                              <div style="width: 100%; margin-bottom: 10px; text-align: center;">
                                                <img src="<?= site_url('uploads/system/logo-dark.png'); ?>" style="width: 200px;">
                                              </div>
                                              <hr style="border: 1px solid #efefef; margin-top: 30px;">
                                              <p style="text-align: center;">Verify your email address</p>
                                              <div style="width: 100%; margin-bottom: 20px; text-align: center;">
                                                <img src="<?= site_url('assets/global/mail/email-verification.png'); ?>" style="width: 160px; height: 150px;">
                                              </div>
