                                        ...
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                              <div style="width: 100%; margin-bottom: 10px; text-align: center;">
                                                <img src="<?= site_url('uploads/system/logo-dark.png'); ?>" style="width: 300px;">
                                              </div>
                                              <p style="text-align: center; background-color: #bc1b88; color: #fff; padding: 20px; margin-bottom: 30px;"><?= $subject; ?></p>
