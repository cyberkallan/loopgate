<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-webpack title_icon"></i> <?php echo get_phrase('add_new_addon'); ?>
...
<div class="col-xl-5">
    <?php if (!class_exists('ZipArchive')): ?>
        <div class="alert alert-info" role="alert">
            <strong>N.B - </strong> <?php echo get_phrase('make_sure').'<strong> ZipArchive </strong> '.get_phrase('is_enabled_before_addon_installation'); ?>.
        </div>
    <?php endif; ?>
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="addon_zip" name="addon_zip" required onchange="changeTitleOfImageUploader(this)" required>
