        ...
        <div class="panel panel-default" data-collapsed="0"
          style="border-color: #dedede;">
            ...
            <p style="font-size: 14px;">
              Welcome to Loopgate-LMS Installation. You will need to know the following items before
              proceeding.For Any Dowts Instagram Me: arz_beats
            </p>
            <ol>
              <li>Denotech Purchase code</li>
              <li>Database Name</li>
